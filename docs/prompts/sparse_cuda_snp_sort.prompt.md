...
2.  **Goals:** The primary goal is to implement the SNP simulation using a sparse representation to reduce memory overhead and improve computation speed. The implementation should be capable of handling large-scale SNP models efficiently.
