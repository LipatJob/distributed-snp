...
\begin{itemize}
    \item \texttt{src/snp}: Contains the core SNP simulation logic, including the simulator interfaces and concrete implementations (e.g., \texttt{OptimizedCudaMpiSnpSimulator}, \texttt{SparseCudaSnpSimulator}), as well as graph partitioners (Linear, Louvain).
